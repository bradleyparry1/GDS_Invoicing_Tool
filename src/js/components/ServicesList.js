...
function ServiceList(props) {
  ...
  const orderServices = (services) => {
    return reverse(
      sortBy(services, (service) => calculateServiceUsageBillingTotal(service))
    );
  };
          ...
          <Col>
            <Container className="usage-window">
              {map(orderedServices, (service) => {
                const serviceBillingTotal =
                  calculateServiceUsageBillingTotal(service);
                return (
